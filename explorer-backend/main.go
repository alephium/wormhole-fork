...
import (
	...
	"github.com/alephium/wormhole-fork/explorer-backend/migration"
	"github.com/alephium/wormhole-fork/explorer-backend/notifier"
	"github.com/alephium/wormhole-fork/explorer-backend/processor"
	"github.com/alephium/wormhole-fork/explorer-backend/server"
	"github.com/alephium/wormhole-fork/explorer-backend/storage"
	"github.com/alephium/wormhole-fork/explorer-backend/transactions"
...
func run(cmd *cobra.Command, args []string) {
	...
	logger := ipfslog.Logger("wormhole-explorer-backend").Desugar()
