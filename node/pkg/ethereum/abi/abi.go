...
// NextSequence is a free data retrieval call binding the contract method 0xf8c280b1.
//
// Solidity: function nextSequence(address emitter, uint16 targetChainId) view returns(uint64)
func (_Abi *AbiCaller) NextSequence(opts *bind.CallOpts, emitter common.Address, targetChainId uint16) (uint64, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "nextSequence", emitter, targetChainId)
...
//
// Solidity: function nextSequence(address emitter, uint16 targetChainId) view returns(uint64)
func (_Abi *AbiSession) NextSequence(emitter common.Address, targetChainId uint16) (uint64, error) {
	return _Abi.Contract.NextSequence(&_Abi.CallOpts, emitter, targetChainId)
}

// NextSequence is a free data retrieval call binding the contract method 0xf8c280b1.
//
// Solidity: function nextSequence(address emitter, uint16 targetChainId) view returns(uint64)
func (_Abi *AbiCallerSession) NextSequence(emitter common.Address, targetChainId uint16) (uint64, error) {
	return _Abi.Contract.NextSequence(&_Abi.CallOpts, emitter, targetChainId)
}
...
//
// Solidity: function quorum(uint256 numGuardians) pure returns(uint256 numSignaturesRequiredForQuorum)
func (_Abi *AbiCaller) Quorum(opts *bind.CallOpts, numGuardians *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "quorum", numGuardians)
...
//
// Solidity: function quorum(uint256 numGuardians) pure returns(uint256 numSignaturesRequiredForQuorum)
func (_Abi *AbiSession) Quorum(numGuardians *big.Int) (*big.Int, error) {
	return _Abi.Contract.Quorum(&_Abi.CallOpts, numGuardians)
}

// Quorum is a free data retrieval call binding the contract method 0xf8ce560a.
//
// Solidity: function quorum(uint256 numGuardians) pure returns(uint256 numSignaturesRequiredForQuorum)
func (_Abi *AbiCallerSession) Quorum(numGuardians *big.Int) (*big.Int, error) {
	return _Abi.Contract.Quorum(&_Abi.CallOpts, numGuardians)
}
...
// PublishMessage is a paid mutator transaction binding the contract method 0x03cdf0a2.
//
// Solidity: function publishMessage(uint16 targetChainId, uint32 nonce, bytes payload, uint8 consistencyLevel) payable returns(uint64 sequence)
func (_Abi *AbiTransactor) PublishMessage(opts *bind.TransactOpts, targetChainId uint16, nonce uint32, payload []byte, consistencyLevel uint8) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "publishMessage", targetChainId, nonce, payload, consistencyLevel)
}

// PublishMessage is a paid mutator transaction binding the contract method 0x03cdf0a2.
//
// Solidity: function publishMessage(uint16 targetChainId, uint32 nonce, bytes payload, uint8 consistencyLevel) payable returns(uint64 sequence)
func (_Abi *AbiSession) PublishMessage(targetChainId uint16, nonce uint32, payload []byte, consistencyLevel uint8) (*types.Transaction, error) {
	return _Abi.Contract.PublishMessage(&_Abi.TransactOpts, targetChainId, nonce, payload, consistencyLevel)
}

// PublishMessage is a paid mutator transaction binding the contract method 0x03cdf0a2.
//
// Solidity: function publishMessage(uint16 targetChainId, uint32 nonce, bytes payload, uint8 consistencyLevel) payable returns(uint64 sequence)
func (_Abi *AbiTransactorSession) PublishMessage(targetChainId uint16, nonce uint32, payload []byte, consistencyLevel uint8) (*types.Transaction, error) {
	return _Abi.Contract.PublishMessage(&_Abi.TransactOpts, targetChainId, nonce, payload, consistencyLevel)
}
...
// FilterLogMessagePublished is a free log retrieval operation binding the contract event 0xcd7b525350dfac7e06deb9b3a8f19ceb75cf6cd2914cd0b2d7bf9d9a3d9babff.
//
// Solidity: event LogMessagePublished(address indexed sender, uint16 targetChainId, uint64 sequence, uint32 nonce, bytes payload, uint8 consistencyLevel)
...
// WatchLogMessagePublished is a free log subscription operation binding the contract event 0xcd7b525350dfac7e06deb9b3a8f19ceb75cf6cd2914cd0b2d7bf9d9a3d9babff.
//
// Solidity: event LogMessagePublished(address indexed sender, uint16 targetChainId, uint64 sequence, uint32 nonce, bytes payload, uint8 consistencyLevel)
...
// ParseLogMessagePublished is a log parse operation binding the contract event 0xcd7b525350dfac7e06deb9b3a8f19ceb75cf6cd2914cd0b2d7bf9d9a3d9babff.
//
// Solidity: event LogMessagePublished(address indexed sender, uint16 targetChainId, uint64 sequence, uint32 nonce, bytes payload, uint8 consistencyLevel)
