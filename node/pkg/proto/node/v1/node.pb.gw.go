...
func request_NodePrivilegedService_GetNextGovernanceVAASequence_0(ctx context.Context, marshaler runtime.Marshaler, client NodePrivilegedServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNextGovernanceVAASequenceRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetNextGovernanceVAASequence(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_NodePrivilegedService_GetNextGovernanceVAASequence_0(ctx context.Context, marshaler runtime.Marshaler, server NodePrivilegedServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNextGovernanceVAASequenceRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetNextGovernanceVAASequence(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterNodePrivilegedServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NodePrivilegedServiceServer) error {
	...
	mux.Handle("POST", pattern_NodePrivilegedService_GetNextGovernanceVAASequence_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/node.v1.NodePrivilegedService/GetNextGovernanceVAASequence", runtime.WithHTTPPathPattern("/node.v1.NodePrivilegedService/GetNextGovernanceVAASequence"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_NodePrivilegedService_GetNextGovernanceVAASequence_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_NodePrivilegedService_GetNextGovernanceVAASequence_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterNodePrivilegedServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NodePrivilegedServiceClient) error {
	...
	mux.Handle("POST", pattern_NodePrivilegedService_GetNextGovernanceVAASequence_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/node.v1.NodePrivilegedService/GetNextGovernanceVAASequence", runtime.WithHTTPPathPattern("/node.v1.NodePrivilegedService/GetNextGovernanceVAASequence"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_NodePrivilegedService_GetNextGovernanceVAASequence_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_NodePrivilegedService_GetNextGovernanceVAASequence_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"node.v1.NodePrivilegedService", "GetNextGovernanceVAASequence"}, ""))
)
...
var (
	...
	forward_NodePrivilegedService_GetNextGovernanceVAASequence_0 = runtime.ForwardResponseMessage
)
