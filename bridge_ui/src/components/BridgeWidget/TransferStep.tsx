...
const ExpandButtonProgress = () => {
  ...
  const isStep1 = isWalletApproved && !signedVAA
  const isStep2 = !!signedVAA
      ...
      <div className={classes.chainSelectContainer}>
        <div className={classes.sendStep}>
          ...
          <div>
            ...
            <div className={classes.sendStepContentSubtitle}>
              Bridging has started. Your tokens will soon arrive to your wallet. See below for details.
            </div>
          </div>
        </div>
      </div>
...
const RedeemProgress = () => {
  ...
  return (
    <div className={classes.transferProgressContainer}></div>
...
const TransferProgress = () => {
  ...
  return (
    <div className={classes.transferProgressContainer}>
      ...
      <div className={classes.transferProgressRow} style={{ color: !!signedVAA ? 'inherit' : GRAY }}>
        <div className={classes.transferProgressIcon}>
          {step4Completed ? (
            <CheckCircleOutlineRounded style={{ color: '#189b3c' }} />
          ) : (
        ...
        <div className={classes.transferProgressContent}>
          {step4Completed ? <Typography>Received proof!</Typography> : <Typography>Waiting for proof...</Typography>}
        </div>
      </div>
      ...
      <div className={classes.transferProgressRow} style={{ color: isSendComplete ? 'inherit' : GRAY }}>
        ...
        <div className={classes.transferProgressContent}>
          <Typography>Submitting proof...</Typography>
        </div>
      </div>
      ...
      <div className={classes.transferProgressRow} style={{ color: isSendComplete ? 'inherit' : GRAY }}>
        ...
        <div className={classes.transferProgressContent}>
          <Typography>Sending tokens...</Typography>
        </div>
      </div>
    </div>
  )
...
const FinalityProgress = ({ isActive }: { isActive: boolean }) => {
  ...
  const signedVAA = useTransferSignedVAA()
  const isCompleted = remainingBlocksForFinality === 0 || !!signedVAA
