...
const WalletAddressButton = ({
  ...
  return (
    <>
      <ButtonBase
        className={clsx(
          onlyShowChainIcon && classes.buttonIconOnly,
      ...
      >
        {iconElement ? (
          <span
            className={clsx(
              classes.iconWrapper,
              iconType === "chainLogo" ? classes.chainLogoIcon : classes.genericIcon
            )}
          >
            {iconElement}
          </span>
        ...
        {showLabelOnButton ? (
          <span className={classes.labelWrapper}>{labelContent}</span>
        ) : null}
      </ButtonBase>
      <Popover
        open={open}
      ...
      >
        <div className={classes.popoverHeader}>
          ...
          {headerSubtitle ? (
            <Typography className={classes.popoverSubtitle}>{headerSubtitle}</Typography>
          ) : null}
        </div>
        <Divider />
        <List>
